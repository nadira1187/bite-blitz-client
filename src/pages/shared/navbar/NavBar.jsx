              ...
              {user ? (
                <div className="relative">
                  ...
                  <button
                    ...
                    className="w-12 h-12 rounded-full overflow-hidden ring-2 ring-white/30 shadow-lg"
                  >
                    <img
                  ...
                  {isDropdownOpen && (
                    <>
                      ...
                      <div className="absolute right-0 mt-3 w-64 bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 overflow-hidden z-50">
